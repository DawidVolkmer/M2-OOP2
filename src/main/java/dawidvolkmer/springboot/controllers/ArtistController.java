...
import dawidvolkmer.springboot.commands.ArtistCommand;
import dawidvolkmer.springboot.converters.ArtistCommandToArtist;
...
public class ArtistController {
    ...
    public ArtistController(ArtistRepository artistRepository, SongRepository songRepository,ArtistCommandToArtist artistCommandToArtist) {
